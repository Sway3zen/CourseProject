...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ÔÂÂ≥ÎÍ“ÂÒÚ≥‚ToolStripMenuItem->Size = System::Drawing::Size(112, 21);
			this->ÔÂÂ≥ÎÍ“ÂÒÚ≥‚ToolStripMenuItem->Text = L"œÂÂÎ≥Í ÚÂÒÚ≥‚";
			this->ÔÂÂ≥ÎÍ“ÂÒÚ≥‚ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Switchtask::ÔÂÂ≥ÎÍ“ÂÒÚ≥‚ToolStripMenuItem_Click);
			// 
			// ÒÚ‚ÓËÚË“ÂÒÚToolStripMenuItem
			// 
			this->ÒÚ‚ÓËÚË“ÂÒÚToolStripMenuItem->Name = L"ÒÚ‚ÓËÚË“ÂÒÚToolStripMenuItem";
			this->ÒÚ‚ÓËÚË“ÂÒÚToolStripMenuItem->Size = System::Drawing::Size(113, 21);
			this->ÒÚ‚ÓËÚË“ÂÒÚToolStripMenuItem->Text = L"—Ú‚ÓËÚË ÚÂÒÚ";
			this->ÒÚ‚ÓËÚË“ÂÒÚToolStripMenuItem->Click += gcnew System::EventHandler(this, &Switchtask::ÒÚ‚ÓËÚË“ÂÒÚToolStripMenuItem_Click);
			// 
			// ÂÁÛÎ¸Ú‡ÚË“ÂÒÚ≥‚ToolStripMenuItem
			// 
			this->ÂÁÛÎ¸Ú‡ÚË“ÂÒÚ≥‚ToolStripMenuItem->Name = L"ÂÁÛÎ¸Ú‡ÚË“ÂÒÚ≥‚ToolStripMenuItem";
			this->ÂÁÛÎ¸Ú‡ÚË“ÂÒÚ≥‚ToolStripMenuItem->Size = System::Drawing::Size(137, 21);
			this->ÂÁÛÎ¸Ú‡ÚË“ÂÒÚ≥‚ToolStripMenuItem->Text = L"–ÂÁÛÎ¸Ú‡ÚË ÚÂÒÚ≥‚";
			this->ÂÁÛÎ¸Ú‡ÚË“ÂÒÚ≥‚ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Switchtask::ÂÁÛÎ¸Ú‡ÚË“ÂÒÚ≥‚ToolStripMenuItem_Click);
			// 
			// Â‰‡„Û‚‡ÌÌˇ“ÂÒÚ≥‚ToolStripMenuItem
			// 
			this->Â‰‡„Û‚‡ÌÌˇ“ÂÒÚ≥‚ToolStripMenuItem->Name = L"Â‰‡„Û‚‡ÌÌˇ“ÂÒÚ≥‚ToolStripMenuItem";
			this->Â‰‡„Û‚‡ÌÌˇ“ÂÒÚ≥‚ToolStripMenuItem->Size = System::Drawing::Size(146, 21);
			this->Â‰‡„Û‚‡ÌÌˇ“ÂÒÚ≥‚ToolStripMenuItem->Text = L"–Â‰‡„Û‚‡ÌÌˇ ÚÂÒÚ≥‚";
			this->Â‰‡„Û‚‡ÌÌˇ“ÂÒÚ≥‚ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Switchtask::Â‰‡„Û‚‡ÌÌˇ“ÂÒÚ≥‚ToolStripMenuItem_Click);
			// 
			// Switchtask
			// 
...
private: System::Void ÔÂÂ≥ÎÍ“ÂÒÚ≥‚ToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	this->Hide();
	ListTestForm^ listform = gcnew ListTestForm();
	listform->ShowDialog();
	this->Show();
}
private: System::Void ÒÚ‚ÓËÚË“ÂÒÚToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	this->Hide();
	CreateTest^ createTest = gcnew CreateTest();
	createTest->ShowDialog();
	this->Show();
}
private: System::Void ÂÁÛÎ¸Ú‡ÚË“ÂÒÚ≥‚ToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	this->Hide();
	ViewResultTest^ viewres = gcnew ViewResultTest();
	viewres->ShowDialog();
	this->Show();
}
private: System::Void Â‰‡„Û‚‡ÌÌˇ“ÂÒÚ≥‚ToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
}
};
}
